...
let SocialMedia = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = call({}), _dec4 = call({}), _dec5 = view(), _dec6 = call({}), _dec7 = call({}), _dec8 = call({}), _dec9 = call({}), _dec10 = view(), _dec(_class = (_class2 = class SocialMedia {
  constructor() {
  ...
  like_a_post({
    ...
    post.users_who_likes.push(sender_id);
  ...
  get_my_liked_posts({}) {
    ...
    if (this.likes_by_user_id.get(sender_id) != null) {
      my_like_posts = this.likes_by_user_id.get(sender_id);
    } else {
      return [];
    }
...
}, (_applyDecoratedDescriptor(_class2.prototype, "add_post", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "add_post"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "delete_all_posts", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "delete_all_posts"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "delete_post_by_id", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "delete_post_by_id"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_all_posts", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "get_all_posts"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "add_posts_by_tag", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "add_posts_by_tag"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "add_post_to_my_liked", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "add_post_to_my_liked"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "like_a_post", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "like_a_post"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_my_liked_posts", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "get_my_liked_posts"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_posts_by_tag", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "get_posts_by_tag"), _class2.prototype)), _class2)) || _class);
function get_posts_by_tag() {
  const _state = SocialMedia._getState();
  if (!_state && SocialMedia._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = SocialMedia._create();
  if (_state) {
    SocialMedia._reconstruct(_contract, _state);
  }
  const _args = SocialMedia._getArgs();
  const _result = _contract.get_posts_by_tag(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SocialMedia._serialize(_result, true));
}
function get_my_liked_posts() {
  ...
  const _args = SocialMedia._getArgs();
  const _result = _contract.get_my_liked_posts(_args);
...
function like_a_post() {
  ...
  const _args = SocialMedia._getArgs();
  const _result = _contract.like_a_post(_args);
  SocialMedia._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SocialMedia._serialize(_result, true));
}
function add_post_to_my_liked() {
  const _state = SocialMedia._getState();
  if (!_state && SocialMedia._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = SocialMedia._getArgs();
  const _result = _contract.add_post_to_my_liked(_args);
  SocialMedia._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SocialMedia._serialize(_result, true));
}
function add_posts_by_tag() {
  const _state = SocialMedia._getState();
  if (!_state && SocialMedia._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = SocialMedia._getArgs();
  const _result = _contract.add_posts_by_tag(_args);
  SocialMedia._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SocialMedia._serialize(_result, true));
}
...
function delete_post_by_id() {
  ...
  const _args = SocialMedia._getArgs();
  const _result = _contract.delete_post_by_id(_args);
  SocialMedia._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SocialMedia._serialize(_result, true));
}
function delete_all_posts() {
  ...
  const _args = SocialMedia._getArgs();
  const _result = _contract.delete_all_posts(_args);
  SocialMedia._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SocialMedia._serialize(_result, true));
}
function add_post() {
...
export { add_post, add_post_to_my_liked, add_posts_by_tag, delete_all_posts, delete_post_by_id, get_all_posts, get_my_liked_posts, get_posts_by_tag, like_a_post };
